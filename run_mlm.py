...
class DataTrainingArguments:
    ...
    """
    data_path_custom: Optional[str] = field(
        default=None, metadata={"help": "Path of local dataset"}
    )
...
def main():
    ...
    if data_args.dataset_name == "custom":
        ...
        if data_args.data_path_custom is not None:
    ...
    if model_args.tokenizer_name:
        ...
        tokenizer = TamilCharacterTokenizer(model_max_length=4096, truncation=True, max_length=4096)
